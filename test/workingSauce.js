...
describe("Working Sauce", function () {
  it("should go to Google and click Sauce", async function () {
    ...
    // // Task I
    // let search = await driver.findElement(By.id("i am a link"));
    //     await search.click();

    // // Task II
    // let search = await driver.findElement(By.name("i_am_a_textbox"));
    // await search.clear();
    // await search.sendKeys("Sauce");

    // // Task III
    // let search = await driver.findElement(By.name("fbemail"));
    //   await search.sendKeys("Sauce");
